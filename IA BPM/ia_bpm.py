...
CTkLabel(frame).grid(columnspan=2, row=0)

correo = CTkEntry(frame, placeholder_text= 'Correo electronico', 
...
bt_google= CTkButton(frame, border_color='#7f5af0', fg_color='#010101', 
	hover_color='#16161a',corner_radius=12,border_width=2,
    text=' Google Login ')
bt_google.grid(column = 0, row=6, padx=4, pady =4)

bt_facebook = CTkButton(frame,  border_color='#7f5af0', fg_color='#010101',
	hover_color='#16161a',corner_radius=12,border_width=2,
    text='Facebook  Login')
